...
const PenggunaProfile = ({ navigation }) => {
    ...
    const handleSaveProfile = async () => {
        ...
        try {
            // Prepare updated user data (with phone number for Pengguna)
            const updatedData = {
                ...userData,
                nama: nama.trim(),
                        ...
                        {isEditing ? (
                            ...
                            <VStack space={4}>
                                ...
                                <VStack space={2}>
                                    ...
                                    <Text>{userData.phoneNumber || 'Belum diisi'}</Text>
                                </VStack>
...
export default PenggunaProfile;