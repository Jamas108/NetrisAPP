...
const PenggunaAbout = () => {
    ...
    // Function to open the manual book link
    const openManualBook = () => {
        Linking.openURL('https://drive.google.com/file/d/1MnUpjmgUXwSstqyTDP-nFPAFW-PEy9SA/view?usp=drive_link');
    };
    ...
    return (
        <>
            ...
            <ScrollView>
                ...
                <Box bg="#E62E05" py={16} px={6}>
                    <VStack space={4} alignItems="center">
                        ...
                        <Button 
                            ...
                            size="lg"
                            colorScheme="white"
                            _text={{ color: "#E62E05", fontWeight: "bold" }}
                            onPress={openManualBook}
                            shadow={3}
                            rounded="full"
                            px={6}
                            bg={"white"}
                ...
                {/* Footer Section with Manual Book Button */}
                <Box bg="orange.100" py={8} px={6}>
                    <Container maxW="container.lg">
                        <VStack space={6}>
                            {/* Additional Manual Book Button in Footer */}
                            <Box alignItems="center" alignSelf={"center"} width="100%">
                                <Button
                                    size="lg"
                                    bg="#E62E05"
                                    _text={{ color: "white", fontWeight: "bold" }}
                                    leftIcon={<Icon as={MaterialIcons} name="menu-book" size="sm" color="white" />}
                                    onPress={openManualBook}
                                    shadow={2}
                                    px={8}
                                    py={3}
